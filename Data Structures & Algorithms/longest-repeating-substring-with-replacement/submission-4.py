class Solution:
    def characterReplacement(self, s: str, k: int) -> int:
        ...
        for j, letter in enumerate(s):
            ...
            # constraint?
            # if freq of dominant letter and converted chars >= substring length,
            # good! But otherwise, that means there are other letters that aren't
            # a dominant letter and k isn't enough to convert them -> INVALID
